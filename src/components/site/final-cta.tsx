  ...
  return (
    <section className="relative overflow-hidden py-16 sm:py-28">
      ...
      <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
        <h2 className="font-display text-3xl leading-tight tracking-tight text-white sm:text-5xl md:text-6xl">
        ...
        <div className="mt-8 flex justify-center">
          <Button
            ...
            className="w-full gradient-vice text-white glow-pink hover:opacity-90 sm:w-auto"
          >
